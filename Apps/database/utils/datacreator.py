...
class CircleGen:
    def __init__(self, width, height, count_light, count_dark, path_to_directory):
        ...
        self.background_dark = [(44, 41, 6), (41, 24, 52), (21, 39, 60), (52, 0, 27), (39, 56, 50), (62, 37, 34), (58, 13, 61), (62, 5, 41), (23, 20, 33), (20, 25, 50)]
        self.background_light = [(187, 180, 233), (190, 179, 152), (244, 157, 158), (167, 191, 186), (162, 208, 255), (198, 208, 195), (212, 194, 163), (223, 152, 167), (243, 186, 199), (241, 241, 242)]
            ...
            for y in range(self.num_object()):
                ...
                while True:
                    ...
                    if (len(circles_created) == 0 or not (
                        ...
                        draw.ellipse((x - r, y - r, x + r, y + r), fill=self.generate_fill(self.get_fill("light", case)),
    ...
    def create_moon_shaped_circles(self, image, circles_array, background_color, case):
        ...
        while True:
            ...
            if (len(circles_array) == 0 or not (
                ...
                draw.ellipse((x - r, y - r, x + r, y + r), fill=self.generate_fill(self.get_fill(background_color, case)),
                            width=self.generate_width(r))
